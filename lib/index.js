...
var GithubActivity = function (_React$Component) {
  ...
  GithubActivity.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      !errors && user && _react2.default.createElement(_User2.default, { user: user, login: login }),
      repositories && repositories.length ? _react2.default.createElement(
        'section',
        { className: 'c-git-activity__repositories' },
        repositories.map(function (x) {
          return _react2.default.createElement(_Repository2.default, _extends({
            key: x.id
          }, x));
        })
...
exports.default = GithubActivity;
